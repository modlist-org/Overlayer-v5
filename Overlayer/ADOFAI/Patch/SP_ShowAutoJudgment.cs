...
public class SP_ShowAutoJudgment : SafeConditionalPatch {
    public SP_ShowAutoJudgment() : base(nameof(SP_ShowAutoJudgment)) { }

    protected override bool ShouldApply() => MainCore.Config.ShowAutoplayJudgment;
